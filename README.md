# roswasm_suite
Libraries for compiling C++ ROS nodes to Webassembly using Emscripten. This allows you to write c++ ROS nodes similar to how you would otherwise, and to then  have them run in a webbrowser and communicate with ROS through `rosbridge_websocket`.
